  ...
  <section class="home-section">
    <div class="container">
      <div class="page-title d-flex mt-1 mb-4">
        E-MANAJEMEN INTERVENSI KESEJAHTERAAN SOSIAL <i class='bx bx-chevron-right mr-1 ml-1'></i> <span>Laporan Intervensi</span>
      </div>
      <div class="search-bar mb-3 d-flex">
        <div class="input-group mr-2">
          <input type="text" name="searchLaporan" id="searchLaporan" class="form-control shadow-none" placeholder="cari laporan..." aria-label="cari laporan..." aria-describedby="button-addon2">
